...
export interface ProcurementRepository {
  ...
  createSupplier(input: SupplierCreateInput, tenantId: string): Promise<Supplier>;
  updateSupplier(id: string, input: SupplierUpdateInput, tenantId: string, expectedUpdatedAt?: string): Promise<Supplier | null>;
  archiveSupplier(id: string, tenantId: string, userId: string | null): Promise<Supplier>;
  restoreSupplier(id: string, tenantId: string): Promise<Supplier>;
  listPurchaseOrders(params: ProcurementListParams, tenantId: string): Promise<PagedResult<PurchaseOrder>>;
  createPurchaseOrder(input: PurchaseOrderCreateInput, tenantId: string): Promise<PurchaseOrder>;
  updatePurchaseOrder(id: string, input: PurchaseOrderUpdateInput, tenantId: string, expectedUpdatedAt?: string): Promise<PurchaseOrder | null>;
  submitPurchaseOrder(id: string, tenantId: string, expectedUpdatedAt?: string): Promise<PurchaseOrder | null>;
  cancelPurchaseOrder(id: string, tenantId: string, expectedUpdatedAt?: string): Promise<PurchaseOrder | null>;
...
export const procurementRepository: ProcurementRepository = {
  ...
  async createSupplier(input, tenantId) {
    ...
    }, procurementCtx(tenantId, "procurement.supplier.create", "critical"));
    if (error) {
  ...
  async updateSupplier(id, input, tenantId, expectedUpdatedAt) {
    ...
    const { data, error } = await platformRepository.rpc("command_supplier", {
      ...
      p_operation_trace_id: null,
      p_workflow_trace_id: null,
    }, procurementCtx(tenantId, "procurement.supplier.update", "critical"));
    if (error) {
  ...
  async archiveSupplier(id, tenantId, userId) {
    const { data, error } = await platformRepository.rpc("command_supplier", {
      p_operation: "archive",
      p_supplier_id: id,
      p_tenant_id: tenantId,
      ...
      p_operation_trace_id: null,
      p_workflow_trace_id: null,
    }, procurementCtx(tenantId, "procurement.supplier.archive", "critical"));
    if (error) {
  ...
  async restoreSupplier(id, tenantId) {
    const { data, error } = await platformRepository.rpc("command_supplier", {
      p_operation: "restore",
      p_supplier_id: id,
      p_tenant_id: tenantId,
      ...
      p_operation_trace_id: null,
      p_workflow_trace_id: null,
    }, procurementCtx(tenantId, "procurement.supplier.restore", "critical"));
    if (error) {
  ...
  async createPurchaseOrder(input, tenantId) {
    const { data, error } = await platformRepository.rpc("command_purchase_order", {
      ...
      p_operation_trace_id: null,
      p_workflow_trace_id: null,
    }, procurementCtx(tenantId, "procurement.purchaseOrder.create", "critical"));
    if (error) {
  ...
  async updatePurchaseOrder(id, input, tenantId, expectedUpdatedAt) {
    const payload: Record<string, unknown> = {};
    ...
    const { data, error } = await platformRepository.rpc("command_purchase_order", {
      ...
      p_operation_trace_id: null,
      p_workflow_trace_id: null,
    }, procurementCtx(tenantId, "procurement.purchaseOrder.update", "critical"));
    if (error) {
  ...
  async submitPurchaseOrder(id, tenantId, expectedUpdatedAt) {
    const { data, error } = await platformRepository.rpc("command_purchase_order", {
      p_operation: "submit",
      p_purchase_order_id: id,
      p_tenant_id: tenantId,
      ...
      p_operation_trace_id: null,
      p_workflow_trace_id: null,
    }, procurementCtx(tenantId, "procurement.purchaseOrder.submit", "critical"));
    if (error) {
  ...
  async cancelPurchaseOrder(id, tenantId, expectedUpdatedAt) {
    const { data, error } = await platformRepository.rpc("command_purchase_order", {
      p_operation: "cancel",
      p_purchase_order_id: id,
      p_tenant_id: tenantId,
      ...
      p_operation_trace_id: null,
      p_workflow_trace_id: null,
    }, procurementCtx(tenantId, "procurement.purchaseOrder.cancel", "critical"));
    if (error) {
